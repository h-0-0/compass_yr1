...
def plot_CTL(results_df, model_name, path=False, xs = False):
    ...
    if xs == False:
        ...
        plt.plot(xs, train_CTL, label="Training CTL")
        plt.plot(xs, test_CTL, label="Testing CTL")
...
def plot_CTA(results_df, model_name, path=False, xs = False):
    ...
    if xs == False:
        ...
        plt.plot(xs, train_CTA, label="Training CTA")
        plt.plot(xs, test_CTA, label="Testing CTA")
        plt.xlabel("Task.Epoch")
        plt.xticks(xs, [str(x) for x in xs])
    plt.ylabel("CTA")
...
def plot_PTL(results_df, model_name, path=False, xs = False):
    ...
    if xs == False:
        ...
        plt.plot(xs, train_PTL, label="Training PTL")
        plt.plot(xs, test_PTL, label="Testing PTL")
        plt.xlabel("Task.Epoch")
        plt.xticks(xs, [str(x) for x in xs])
    plt.ylabel("PTL")
...
def plot_PTA(results_df, model_name, path=False, xs = False):
    ...
    if xs == False:
        ...
        plt.plot(xs, train_PTA, label="Training PTA")
        plt.plot(xs, test_PTA, label="Testing PTA")
        plt.xlabel("Task.Epoch")
        plt.xticks(xs, [str(x) for x in xs])
    plt.ylabel("PTA")
...
def plot_TLs(results_df, model_name, path=False, xs = False):
    ...
    for task_id in task_ids:
        ...
        if xs == False:
            ...
            plt.plot(xs, train_TL, label="Training TL for task "+ task_id)
            plt.plot(xs, test_TL, label="Testing TL for task "+ task_id)
            plt.xlabel("Task.Epoch")
            plt.xticks(xs, [str(x) for x in xs])
...
def plot_TAs(results_df, model_name, path=False, xs = False):
    ...
    for task_id in task_ids:
        ...
        if xs == False:
            ...
            plt.plot(xs, train_TA, label="Training TA for task "+ task_id)
            plt.plot(xs, test_TA, label="Testing TA for task "+ task_id)
            plt.xlabel("Task.Epoch")
            plt.xticks(xs, [str(x) for x in xs])
